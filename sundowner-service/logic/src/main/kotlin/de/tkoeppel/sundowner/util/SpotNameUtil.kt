...
import de.tkoeppel.sundowner.module.geocoding.ReverseGeocodeAdress
import de.tkoeppel.sundowner.to.spots.CoordinateTO

object SpotNameUtil {

	fun getSpotName(type: SpotType, coordinate: CoordinateTO, address: ReverseGeocodeAdress?): String {
		return when {

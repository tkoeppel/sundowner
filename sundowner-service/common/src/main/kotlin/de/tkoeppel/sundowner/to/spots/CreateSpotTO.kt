...
@Schema(
	name = "CreateSpotRequest", description = "Request body for creating a new sunset spot on the map."
)
data class CreateSpotTO(
	@Schema(
		description = "The type of spot (e.g. sunrise or sunset)", required = true
	) val type: SpotType,

	@Schema(
		description = "The geographical coordinates of the sunset spot.", required = true
	...
	@Schema(
		description = "A list of recommended transport methods to reach the spot.", required = true
